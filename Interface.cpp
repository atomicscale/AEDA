...
void Interface::start()
{
	...
	do {
		...
		std::cout << "-----------------" << std::endl;
		std::cout << "- Gestão de Um Clube Desportivo -" << std::endl;
		std::cout << "Data: " << std::endl; //Alterar data
		std::cout << "-----------------" << std::endl;
		std::cout << std::endl;
		std::cout << "Clube" << std::endl;
		std::cout << "1. Criar Clube" << std::endl;
		std::cout << "2. Ver Clubes Existentes" << std::endl;
		std::cout << "3. Remover Clubes" << std::endl;
		std::cout << std::endl;
